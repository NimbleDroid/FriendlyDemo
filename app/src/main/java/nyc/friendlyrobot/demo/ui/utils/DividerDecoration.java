...
/**
 * Created by brianplummer on 3/26/16.
 */
public class DividerDecoration extends RecyclerView.ItemDecoration {
    ...
    public DividerDecoration(Context context, AttributeSet attrs, boolean showFirstDivider,
    ...
    public DividerDecoration(Context context, int resId, boolean showFirstDivider,
                                 boolean showLastDivider) {
        this(context, resId);
        mShowFirstDivider = showFirstDivider;
        mShowLastDivider = showLastDivider;
