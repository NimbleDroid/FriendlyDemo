package nyc.friendlyrobot.anchor.androidboilerplate.runner;

import android.os.Bundle;
import android.support.test.espresso.Espresso;

import nyc.friendlyrobot.anchor.util.RxIdlingExecutionHook;
import nyc.friendlyrobot.anchor.util.RxIdlingResource;
